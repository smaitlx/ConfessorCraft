...
public class DefaultProps {
	...
	public static final String MOD = "ConfessorCraft";

	public static final String DEPENDENCY_CORE = "required-after:ConfessorCraft|Core@" + Version.VERSION;
	public static final String DEPENDENCY_TRANSPORT = "required-after:ConfessorCraft|Transport@" + Version.VERSION;
